...
def create_app(repo_root: Path | None = None) -> FastAPI:
    ...
    app = FastAPI(
        ...
        description="Phase 6 visibility, global and curated per-class run/eval comparison, small whitelisted job control, and a first local FiftyOne bridge for datasets and eval-linked datasets.",
        version="0.6.0",
        lifespan=lifespan,
    )
